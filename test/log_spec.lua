...
describe("#ci Plugin: argonath-kenny-loggins (log)", function()
  ...
  it("logs to argonath-kenny-loggins if log_level is lower", function()
    do_test("logging.com", true)
  end)
  it("does not log to argonath-kenny-loggins if log_level is higher", function()
    do_test("logging2.com", false)
  end)
  it("logs to argonath-kenny-loggins if log_level is the same", function()
